...
const TIPS = [
  ...
  "Create {highlight}dicode.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/dicode/dicode.json{/highlight} for global config",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.dicode/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.dicode/agent/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.dicode/tool/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.dicode/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent CoStrict from reading sensitive files",
  "Use {highlight}dicode run{/highlight} for non-interactive scripting",
  "Use {highlight}dicode run --continue{/highlight} to resume the last session",
  "Use {highlight}dicode run -f file.ts{/highlight} to attach files via CLI",
  ...
  "Create JSON theme files in {highlight}.dicode/themes/{/highlight} directory",
