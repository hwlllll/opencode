export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Dicode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Dicode.",
  ...
  "provider.connect.opencodeZen.line1":
    "Dicode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Dicode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Dicode.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans dicode.json",
  ...
  "dialog.server.description": "Changez le serveur Dicode auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version de Dicode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Dicode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (dicode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    'Le serveur MCP "{{name}}" a échoué. Notez que Dicode ne supporte pas encore l\'authentification MCP.',
  ...
  "sidebar.gettingStarted.line1":
    "Dicode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "Dicode Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Dicode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Dicode",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Dicode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Dicode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème de Dicode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement de Dicode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version de Dicode.",
